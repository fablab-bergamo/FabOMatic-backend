...
class TestMQTT(unittest.TestCase):
    ...
    def test_json_deserialize(self):
        ...
        self.assertEqual(register_maintenance_query.mid, "1234567890")
        ...
        json_alive_query = '{"action": "alive", "mid": "1234567890"}'
        alive_query = AliveQuery.deserialize(json_alive_query)
        self.assertEqual(alive_query.mid, "1234567890")
